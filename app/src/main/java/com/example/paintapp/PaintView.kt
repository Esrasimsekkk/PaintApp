...
class PaintView : View{
    ...
    companion object{
        var pathList = ArrayList<Path>()//yolları saklayıp çizecek
    ...
    private fun init(){
        paintBrush.isAntiAlias = true //fırça darbesini smooth yapıyo
        ...
        params = ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
            ViewGroup.LayoutParams.WRAP_CONTENT )//fırçayı başlatmak için
    }
